...
public class EnvironmentHelperTests
{
    ...
    {
        // Arrange
        Environment.SetEnvironmentVariable("APP_TAGS", null);
    ...
    {
        // Arrange
        Environment.SetEnvironmentVariable("APP_TAGS", "");
    ...
    {
        // Arrange
        Environment.SetEnvironmentVariable("APP_TAGS", "production");
    ...
    {
        // Arrange
        Environment.SetEnvironmentVariable("APP_TAGS", "production,azure,docker");
    ...
    {
        // Arrange
        Environment.SetEnvironmentVariable("APP_TAGS", tag);
    ...
    {
        // Arrange
        Environment.SetEnvironmentVariable("APP_TAGS", $"valid,{invalidTag},also-valid");
    ...
    {
        // Arrange
        Environment.SetEnvironmentVariable("APP_TAGS", "production,invalid tag,azure-01,another invalid!,test#env");
    ...
    {
        // Arrange
        Environment.SetEnvironmentVariable("APP_TAGS", "invalid tag,another invalid!,yet another@invalid&tag");
    ...
    {
        // Arrange
        Environment.SetEnvironmentVariable("APP_TAGS", "test,env,tags");
    ...
    public void GetEnvironmentTags_WithVeryLongValidTag_ReturnsTag()
    {
        ...
        Environment.SetEnvironmentVariable("APP_TAGS", longTag);
    ...
    {
        // Arrange
        Environment.SetEnvironmentVariable("APP_TAGS", "test-env#1@prod$(v2)[backup]/release");
